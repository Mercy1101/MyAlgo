...
/// @warning  线程不安全
inline time_t get_today_specific_time_stamp(const int iHour, const int iMin, const int iSec)
{
...
/// @warning  线程不安全
inline time_t get_specific_timestamp(const int year, const int mouth, const int day, const int hour, const int min,
                                     const int sec)
{
    tm time = {0};
...
/// @warning  线程不安全
inline std::optional<int> get_weedday(const int year, const int mouth, const int day)
{
