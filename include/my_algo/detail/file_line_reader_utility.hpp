...
#ifndef INCLUDE_DETAIL_FILE_LINE_READER_UTILITY_HPP_
#define INCLUDE_DETAIL_FILE_LINE_READER_UTILITY_HPP_
...
public:
    ...
    public:
        ...
        iterator() noexcept : _M_reader(nullptr), _M_offset(0), _M_line(nullptr), _M_size(0), _M_capacity(0) {}
        /**
         * Constructs the beginning iterator.
         *
         * @param reader  pointer to the file_line_reader object
         */
        explicit iterator(file_line_reader* reader) : _M_reader(reader), _M_offset(0), _M_size(0)
        {
        ...
        iterator(const iterator& rhs)
            : _M_reader(rhs._M_reader), _M_offset(rhs._M_offset), _M_size(rhs._M_size), _M_capacity(rhs._M_capacity)
        {
            if (rhs._M_line)
            {
...
private:
    file_line_reader(file_line_reader const&) = delete;
    void operator=(file_line_reader const&) = delete;
    FILE* _M_stream;
    char _M_delimiter;
...
#endif  ///< INCLUDE_DETAIL_FILE_LINE_READER_UTILITY_HPP_